...
export const Service = () => {
  return (
    <div className="px-4 py-16 md:px-8 md:py-8 lg:py-32 lg:px-28 gap-7">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 md:gap-0">
        <div className="flex flex-col gap-6 md:py-9">
          ...
          <form className="w-full">
            <div className="relative">
              <EmailIcon className="absolute top-1/2 -translate-y-1/2 left-5" />
              <input
                type="text"
                className="w-full md:w-[550px] text-[#2E3E5C] bg-[#f1f1fc] py-6 pl-14 pr-52 rounded-xl outline-none"
