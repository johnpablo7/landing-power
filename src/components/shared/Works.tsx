...
export const Works = () => {
  return (
    <div className="min-h-screen px-4 pt-10 pb-16 md:px-8 md:py-16 lg:p-20 2xl:py-32 2xl:px-28 gap-7">
      <div className="mb-8">
        <h1 className="text-[#1E1F4B] text-4xl leading-10 font-bold mb-2 md:mb-7 tracking-[1px]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-7">
        <NavLink to="/" className="flex flex-col gap-2">
          ...
          <p className="text-[#2E3E5C] text-xl md:tracking-[1px] mb-3">
            By information about design the world to the best instructors, heatc
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-4">
          {worklist.map((work) => (
            <div key={work.id} className="flex flex-col gap-1">
              ...
              <h3 className="text-[#1E1F4B] text-2xl font-bold mb-2 md:mb-0">
                {work.name}
              </h3>
            </div>
          ))}
